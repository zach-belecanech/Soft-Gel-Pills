...
public class IbuprofenTest {
    Ibuprofen pill;
    //constants
    //needs a delta to compare margin of error for double getters
    private static final double DELTA = 0.001;
    private static final String DEF_NAME = "Ibuprofen";
    private static final double DEF_STRENGTH = 400.0;
    private static final double DEF_SIZE = 150.25;
    ...
    class IbuprofenMock extends Ibuprofen {
        IbuprofenMock (double strength, double size, String color, String casing, String solution, String active) {
    ...
    public void BeforeEach() {
        pill = new IbuprofenMock(DEF_STRENGTH,DEF_SIZE,DEF_COLOR, DEF_OUTERCAP, DEF_AQUEOUS, DEF_ACTIVE);
    }
