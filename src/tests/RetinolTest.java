...
public class RetinolTest {
    Retinol pill;
    //contsants
    //needs a delta to compare margin of error for double getters
    private static final double DELTA = 0.001;
    private static final String DEF_NAME = "Retinol";
    private static final double DEF_STRENGTH = 475.5;
    private static final double DEF_SIZE = 255.5;
    private static final String DEF_COLOR = "Yellow";
    ...
    class RetinolMock extends Retinol {
        RetinolMock (double strength, double size, String color, String casing, String solution, String active) {
    ...
    public void BeforeEach() {
        pill = new RetinolMock(DEF_STRENGTH,DEF_SIZE,DEF_COLOR, DEF_OUTERCAP, DEF_AQUEOUS, DEF_ACTIVE);
    }
